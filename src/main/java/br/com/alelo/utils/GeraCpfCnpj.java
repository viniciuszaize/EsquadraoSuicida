...
public class GeraCpfCnpj {
	...
	public static String cpf(boolean comPontos) {
		...
		System.out.println("CPF aleatorio gerado: "+retorno+ " < < < < < < < < < < < < < < < < < < < < < <");
		return retorno;
	}
	...
	public static String gerarCNPJFilial(String raizCNPJ) throws Exception {

		raizCNPJ = raizCNPJ.substring(0, 8);
		System.out.println(raizCNPJ.substring(0, 8));
		Random numeroAleatorio = new Random();
		String[] splitRaiz = raizCNPJ.split("");
		int n1 = Integer.parseInt(splitRaiz[0]);
		int n2 = Integer.parseInt(splitRaiz[1]);
		int n3 = Integer.parseInt(splitRaiz[2]);
		int n4 = Integer.parseInt(splitRaiz[3]);
		int n5 = Integer.parseInt(splitRaiz[4]);
		int n6 = Integer.parseInt(splitRaiz[5]);
		int n7 = Integer.parseInt(splitRaiz[6]);
		int n8 = Integer.parseInt(splitRaiz[7]);
		int n9 = numeroAleatorio.nextInt(10);
		...
		// Conctenando os numeros
		String numerosContatenados = String.valueOf(n9) + String.valueOf(n10) + String.valueOf(n11)
				+ String.valueOf(n12);
		// Concatenando o primeiro resto com o segundo.
		String nDigResult = String.valueOf(digito1) + String.valueOf(digito2);
		String numeroGerado = raizCNPJ + numerosContatenados + nDigResult;
